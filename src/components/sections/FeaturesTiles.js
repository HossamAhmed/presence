          ...
          <div className={tilesClasses}>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Building for everyone</h4>
                  <p className="m-0 text-sm">
                    The Metaverse should not discriminate based on your
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Founders</h4>
                  <p className="m-0 text-sm">
                    Presence founders have led many startups up to maturity and
                    have successfully founded many startups in the Bay Area,
                    such as ARleaps, AB3DLaps, 3D Touch, Femto-Soft and Ezosa
                    Companies in USA.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Hardware</h4>
                  <p className="m-0 text-sm">
                    Presence patented hardware solutions brings real events to
                    Metaverse seamlessly
                  </p>
                </div>
              </div>
            </div>
